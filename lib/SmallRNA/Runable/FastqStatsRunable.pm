package SmallRNA::Runable::FastqStatsRunable;

=head1 NAME

SmallRNA::Runable::FastqStatsRunable - A Runable that summarises the content
                                       and sequence ecomposition of a FASTQ file
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc SmallRNA::Runable::FastqStatsRunable
...
use SmallRNA::Process::FastqStatsProcess;

extends 'SmallRNA::Runable::SmallRNARunable';

=head2

 Function: Create a file with summary/statistical information about a FASTQ file
...
sub run
{
  ...
  my $code = sub {
    my $stats_term_name = 'fastq_stats';
    ...
    SmallRNA::Process::FastqStatsProcess::run(input_file_name =>
